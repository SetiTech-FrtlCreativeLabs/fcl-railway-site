      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-xl text-gray-600">
            Discover innovative products and solutions from Frtl Creative Labs
          </p>
        </div>
          ...
          <form onSubmit={handleSearch} className="flex flex-col lg:flex-row gap-4 mb-6">
            ...
            <div className="flex gap-4">
              ...
              >
                ...
                <option value="quantum-computing-interface">Quantum Computing</option>
                <option value="neural-network-optimization">Neural Networks</option>
                <option value="blockchain-integration-suite">Blockchain</option>
              </select>
        ...
        {productsData?.pagination.pages > 1 && (
          <div className="flex justify-center mt-12">
            <div className="flex items-center gap-2">
              ...
              {[...Array(productsData.pagination.pages)].map((_, index) => (
                <button
                  key={index + 1}
